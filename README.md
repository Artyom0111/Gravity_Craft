Gravity Craft — это увлекательный 2D-платформер, в котором вы управляете персонажем, прыгающим между платформами и на орбах, умерающим от шипов. Цель — достичь своего огромного Аватара.
